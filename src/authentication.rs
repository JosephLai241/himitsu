...
pub fn generate_raw_hash(password: &str, salt: &[u8; 32]) -> Result<Vec<u8>, HimitsuError> {
...
pub fn check_authorization(
    ...
    .map_or_else(|error| Err(HimitsuError::Argon2Error(error)), Ok)
}
